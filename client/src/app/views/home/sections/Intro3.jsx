...
class Intro3 extends Component {
	...
	render() {
		...
		let { currentEQARound } = this.state;
		return (
			<section
				className="section section-intro1 section-intro3"
				id="intro3">
						...
						currentEQARound.eqaPlanning ? (
							<Grid
								...
								<div className="section-intro1__subtitle">
									{t('landing_page.eqaPlanning')}{' '}
									{currentEQARound.eqaPlanning.name}
								</div>

								<div className="section-intro1__list">
									<div className="section-intro1__list__item text-muted">
										<Icon color="secondary">alarm_on</Icon>{' '}
										{t('landing_page.startDate')}{' '}
										{Moment(currentEQARound.startDate).format('DD/MM/YYYY')}
									</div>
									<div className="section-intro1__list__item text-muted">
										<Icon color="secondary">alarm_off</Icon>{' '}
										{t('landing_page.endDate')}{' '}
										{Moment(currentEQARound.endDate).format('DD/MM/YYYY')}
									</div>
								</div>
								...
								<div>
									<Fab
										...
										href={
											ConstantList.ROOT_PATH + 'session/signup-register-account'
										}>
...
export default connect(mapStateToProps, { logoutUser })(Intro3);
